...
PolySprite :: PolySprite( SpriteBatchName::Name spriteBatchName, SpriteName::Name _spriteName, float _lineWidth, const Vect &_color, Vect2D originPt, int numVerts, Vect2D *vertList)
{
	this->setName( 0 );
...
{  
	if( display )
	{
		...
		glDrawArrays(GL_LINE_LOOP, 0, this->polyModel->numVerts);
	}
};
