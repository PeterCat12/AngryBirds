...
public:
	...
	PolySprite( SpriteBatchName::Name spriteBatchName, SpriteName::Name spriteName, float lineWidth, const Vect &color, Vect2D originPt, int numVerts, Vect2D *vertList);
