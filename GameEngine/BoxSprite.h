...
public:
	...
	BoxSprite( SpriteBatchName::Name spriteBatchName, SpriteName::Name _spriteName, float lineWidth, const Vect &color, Rect destRect);
...
private:
	...
	void privDraw();
	void privBoxSprite(  SpriteBatchName::Name spriteBatchName, SpriteName::Name _spriteName, float _lineWidth, const Vect &_color, Rect destRect, float angle);
