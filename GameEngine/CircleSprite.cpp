...
CircleSprite :: CircleSprite(  SpriteBatchName::Name spriteBatchName, SpriteName::Name _spriteName, float _lineWidth, const Vect &_color, GameSprite *gSprite)
{
	this->spriteBatchName = spriteBatchName;
	this->privCircleSprite( spriteBatchName,  _spriteName, _lineWidth, _color, Rect(gSprite->posX, gSprite->posY, gSprite->origWidth, gSprite->origHeight) );
}


void CircleSprite :: privCircleSprite(  SpriteBatchName::Name spriteBatchName, SpriteName::Name _spriteName, float _lineWidth, const Vect &_color, Rect destRect)
{
	this->setName( 0 );
